(function() {
    ...
    function scrollfun(event) {
      ...
      if (y != z) {
        if (z == 0) {
          z = y;
          selector1[y - 1].style.transition = "transform 2.5s";
          selector1[y - 1].style.transform = "translateY(-100vh)";
          selector1[y - 1].style.zIndex = zIndex;
          selector2[y - 1].style.transition = "transform 2.5s";
          ...
          selector2[y - 1].style.zIndex = zIndex;
          zIndex++;
          selector1[z-1].style.transition = "transform 2.5s";
          selector1[z-1].style.transform = "translateY(-200vh)";
          selector2[z-1].style.transition = "transform 2.5s";
          selector2[z-1].style.transform = "translateY(200vh)";
          that.moveSlider( y-1 );
          setTimeout(function() {
