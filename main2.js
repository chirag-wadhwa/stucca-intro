    ...
    function scrollfun(event) {
      ...
      if (y != z) {
        if (z == 0) {
          ...
          document.getElementsByClassName("bottomCross")[0].style.animation = "anticlockwise 0.5s linear infinite";
          document.getElementsByClassName("topCross")[0].style.animation = "clockwise 0.5s linear infinite";
